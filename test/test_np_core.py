...
from torchdrum.np.core import envelope_follower
from torchdrum.np.core import EnvelopeFollower
from torchdrum.np.core import HighPassFilter
...
def test_envelope_follower_class(mocker):
    ...
    mocked_ef = mocker.patch("torchdrum.np.core.envelope_follower")
    follower(x)
